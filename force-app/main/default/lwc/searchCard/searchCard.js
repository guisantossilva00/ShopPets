...
export default class SearchCard extends LightningElement {
    ...
    get listingPricePercent() {
        let negotiatedPrice = this.displayData.prices.negotiatedPrice;
        let listingPrice = this.displayData.prices.listingPrice;

        const percentDiscount = ((( negotiatedPrice - listingPrice) / listingPrice) * 100)  * -1; 
